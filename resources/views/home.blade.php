                ...
                <div>
                    ...
                    <div class="grid grid-cols-4 gap-2 mb-4">
                        ...
                        <div class="col-span-3">
                            ...
                            <a href="{{ route('view', $post) }}" class="uppercase text-gray-800 text-xs hover:text-black">Continue Reading <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="mb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    @foreach($category->publishedPosts()->limit(3)->get() as $post)
                        <x-post-item :post="$post" :show-author="false" :show-img="false" />
                    @endforeach
                </div>
            </div>
        </div>
